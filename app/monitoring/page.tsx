    ...
    <div className="flex flex-col gap-4">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Dernière mise à jour: {loading ? "Chargement..." : lastUpdate}
          </p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
        <Card className="bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-950/30 dark:to-orange-950/30">
          ...
          <CardContent>
            <div className="relative h-16 w-full mb-2 rounded-md overflow-hidden">
              <Image
                src="/images/temperature.jpg" // Remplacez par votre chemin d'image
                alt="Température"
                fill
        ...
        <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30">
          ...
          <CardContent>
            <div className="relative h-16 w-full mb-2 rounded-md overflow-hidden">
              <Image
                src="/images/humidity.jpg" // Remplacez par votre chemin d'image
                alt="Humidité de l'air"
                fill
                style={{ objectFit: "cover" }}
                className="rounded-md"
              />
            ...
            <div className="text-2xl font-bold">
              {latestData.airHumidity.toFixed(1)}%
            </div>
        ...
        <Card className="bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-cyan-950/30 dark:to-blue-950/30">
          ...
          <CardContent>
            <div className="relative h-16 w-full mb-2 rounded-md overflow-hidden">
              <Image
                src="/images/soil.jpg" // Remplacez par votre chemin d'image
                alt="Humidité du sol"
                fill
                style={{ objectFit: "cover" }}
                className="rounded-md"
            ...
            <div className="text-2xl font-bold">
              {latestData.soilHumidity.toFixed(1)}%
            </div>
        ...
        <Card className="bg-gradient-to-br from-sky-50 to-blue-50 dark:from-sky-950/30 dark:to-blue-950/30">
          ...
          <CardContent>
            <div className="relative h-16 w-full mb-2 rounded-md overflow-hidden">
              <Image
                src="/images/rain.jpg" // Remplacez par votre chemin d'image
                alt="Précipitation"
                fill
                style={{ objectFit: "cover" }}
                className="rounded-md"
        ...
        <Card className="bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-950/30 dark:to-indigo-950/30">
          ...
          <CardContent>
            <div className="relative h-16 w-full mb-2 rounded-md overflow-hidden">
              <Image
                src="/images/pressure.jpg" // Remplacez par votre chemin d'image
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Données en temps réel et contrôle du système d'irrigation
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="temperature-humidity" className="space-y-4">
            <TabsList className="grid grid-cols-3 mb-4">
              <TabsTrigger value="temperature-humidity">
                Température & Humidité
              </TabsTrigger>
              <TabsTrigger value="precipitation-pressure">
                Précipitation & Pression
              </TabsTrigger>
              <TabsTrigger value="pump-control">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Paramètres actuels et seuils d'activation
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground">
                        La pompe s'active automatiquement lorsque la température
                        est supérieure à 16.3°C, les précipitations sont
                        inférieures à 2.2mm, l'humidité de l'air est inférieure
                        à 62.4 et l'humidité du sol est inférieure à 33.6%.
                      </p>
                    </div>

                    <div className="rounded-md bg-muted p-3">
                      <p className="text-xs">
                        <span className="font-medium">Note:</span> Ces
                        paramètres sont configurés dans le microcontrôleur ESP32
                        et peuvent être ajustés selon les besoins spécifiques de
                        vos espaces verts.
                      </p>
                    </div>
                  </CardContent>
